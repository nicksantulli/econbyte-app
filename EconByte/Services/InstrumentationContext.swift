...
struct InstrumentationContext: Equatable {
    ...
    /// 1.1.4: it and `-EBSkipPermissionPrompts` stand down the first-launch ATT
    /// and notification prompts (`FirstLaunchPermissionPolicy`). Automation
    /// markers for the same reason the others are.
